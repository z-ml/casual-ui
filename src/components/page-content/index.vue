<template>
  <div class="page-content">
    <h2 :id="title.id">{{ $t('layout.component.Nav.' + title.label) }}</h2>
    <p>{{ $t('layout.component.Nav.' + title.describe) }}</p>
    <div
      class="content"
      ...
      :id="item.id"
    >
      <h3>{{ $t('layout.component.Nav.' + item.label) }}</h3>
      <p>{{ $t('layout.component.Nav.' + item.describe) }}</p>
      <div
